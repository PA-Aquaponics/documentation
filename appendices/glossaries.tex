...
\newdualentry{mqtt}
	{MQTT}
	{\textbf{M}essaging \textbf{Q}ueuing \textbf{T}elemetry \textbf{T}ransport}
	{
		Ist ein Netzwerkprotokoll das geeignet ist um Telemetriedaten zwischen zwei Geräten zu versenden. Die Übertragung kann auch bei hoher Verzögerung und beschränktem Netzwerk stattfinden.\cite{MQTT}
	}
...
\newglossaryentry{urbanblue}
{
	name=Urbanblue,
	description={
		Urbanblue\cite{Urbanblue} ist ein Startup welches mit künstlicher Intelligenz die Daten von Aquaponik Systemen analysiert.
	}
}
% ------------------------------------------------
